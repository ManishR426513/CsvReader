      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={4}>
          <Grid xs={6}>
            <>
              {" "}
              <select className="selectuser" onChange={handleChange}>
          ...
          <Grid xs={2}>
            <>
              {" "}
              <button onClick={() => settoggle(!toggle)} className="lowhours">
                Low Hours
              </button>{" "}
            </>
          </Grid>
      ...
      {newArray.length > 0 && (
        <TableContainer component={Paper}>
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            ...
            <td  style={{ color:rowData[14]==="Present "  ?"green" :  rowData[14]===" ½Present "? "orange"      :"red"   }} >     {rowData[14]}    </td>


          {/*         
      {rowData[14]==="Present " ? (
       <td style={{color:"green"}}>{rowData[14]}</td>
      ) : (
        
        <td style={{color:"red"}}>{rowData[14]}</td>
      )}

      */}
                   </StyledTableCell>
                    <StyledTableCell align="left">
                      <td  className="totalHours" >{totalTime[index]}</td>
                    </StyledTableCell>
                    <StyledTableCell align="left">
                      <td> {FloorTime[index]}</td>
                    </StyledTableCell>
                            ...
                            >
                              <TableHead>
                                <TableRow>
                                  ...
                                  <StyledTableCell align="right">
                                    <th className="oclass">Fo</th>
                                  </StyledTableCell>
                                  <StyledTableCell align="right">
                                    <th className="iclass">Ci</th>
                                  </StyledTableCell>
                                  <StyledTableCell align="right">
                                    <th className="oclass">Co</th>
                                  </StyledTableCell>
                                  <StyledTableCell align="right">
                                    <th className="iclass">Mi</th>
                                  </StyledTableCell>
                                  <StyledTableCell align="right">
                                    <th className="oclass">Mo</th>
                                  </StyledTableCell>
                                </TableRow>
                              </TableHead>
                              <TableBody>
                                <tr key={index}>
                                  ...
                                  <StyledTableCell align="right">
                                    <td className="iclasscolor">
                                      {updatedFi.length > 0 &&
                                        updatedFi[index].map((item, i) => (
                                          <p key={i}>{item}</p>
                                        ))}
                                    </td>
                                  </StyledTableCell>
                                  ...
                                  <StyledTableCell align="right">
                                    <td className="oclasscolor">
                                      {updatedFo.length > 0 &&
                                        updatedFo[index].map((item, i) => (
                                          <p key={i}>{item}</p>
                                        ))}
                                    </td>
                                  </StyledTableCell>
